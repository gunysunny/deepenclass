...
const FEATURES = [
    ...
    },
    {
        ...
        imgWrapper: 'w-1/3',
        textWrapper: 'w-2/3 p-3 box-border',
    ...
    },
    {
        ...
        imgWrapper: 'w-1/3',
        textWrapper: 'w-2/3 p-5 box-border text-white',
    ...
    return (
        ...
        {/* 전체 콘텐츠 최대 너비 1440px로 고정, 화면 중앙 정렬, 내부 패딩 추가 */}
            <div className="mx-auto w-full max-w-[1440px] ">
                {/* 컨텐츠 전체를 2열 레이아웃으로 분리, 높이 동일하게 맞추기 */}
                <div className="flex items-stretch">
                {/* ─── 왼쪽: PS5 한 개, 그 아래 AirPods/VisionPro 두 개 ─── */}
                    <div className="w-1/2 flex flex-col">
                        {/* 1. PS5 카드 (왼쪽 위) */}
                        {/* h-full 주어서 오른쪽 높이에 맞춰 늘어남 */}
    ...
    return (
        ...
        {/* h-full 주어서 부모 flex-items-stretch에 맞춰 전체 높이 채움 */}
            <div className="flex items-center justify-between bg-gray-200 h-full box-border">
                {/* 텍스트 영역 (전체 너비의 50%) */}
                <div className="w-1/2 p-5 space-y-4 box-border">
